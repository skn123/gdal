...
#==============================================================================#
SET (gdal_frmts_DIR ${PROJECT_SOURCE_DIR}/gdal/frmts)
#==============================================================================#
...
FOREACH(format ${GDAL_FORMAT_LIST_COMMON})
  OPTION(GDAL_WITH_${format} "Compilation of GDAL format ${format}" ON)
...
FOREACH(format ${GDAL_FORMAT_LIST_COMMON})
  IF(GDAL_WITH_${format})
    ...
    ELSEIF(${format} STREQUAL "gtif")
      INCLUDE_DIRECTORIES(${gdal_frmts_DIR}/${format}/libtiff)
      INCLUDE_DIRECTORIES(${gdal_frmts_DIR}/${format}/libgeotiff)
    ...
    ELSEIF(${format} STREQUAL "aigrid")
      REMOVE(gdal_frmt_SRC "${gdal_frmts_DIR}/${format}/aitest.c")
...
IF(GDAL_WITH_gtiff)
  ...
  FILE(GLOB gdal_libtiff_HDRS 
            ${gdal_frmts_DIR}/gtiff/libtiff/*.h
            ${gdal_frmts_DIR}/gtiff/libgeotiff/*.h)
  
  INCLUDE_DIRECTORIES(${gdal_frmts_DIR}/gtiff
                      ${gdal_frmts_DIR}/gtiff/libtiff
                      ${gdal_frmts_DIR}/gtiff/libgeotiff)
